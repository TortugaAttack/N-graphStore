	...
	public static Collection<Object[]> data() {
		...
		testConfigs.add(new Object[] { new String[][] {
				...
				"<http://dbpedia.org/ontology/birthDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	<http://www.w3.org/2002/07/owl#FunctionalProperty> ."
						+ "<http://dbpedia.org/ontology/deathDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	<http://www.w3.org/2002/07/owl#FunctionalProperty> ." , false});
		testConfigs.add(new Object[] {
				...
				"_:b1	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	<http://www.w3.org/2002/07/owl#FunctionalProperty> ."
						+ "<http://dbpedia.org/ontology/deathDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	_:b1." , false});
		testConfigs.add(new Object[] {
				...
				"<http://dbpedia.org/ontology/birthDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	\"test\" ."
						+ "<http://dbpedia.org/ontology/deathDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	\"test\"@en.", false });
		testConfigs.add(new Object[] {
				new String[][] { { "<http://dbpedia.org/ontology/deathDate>",
						"<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>", "\"test\"^^<urn://test>", null } },
				"<http://dbpedia.org/ontology/deathDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	\"test\"^^<urn://test>" , false});
		testConfigs.add(new Object[] {
				new String[][] { { "http://dbpedia.org/ontology/deathDate>",
						"<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>", "\"test\"^^<urn://test>", null } },
				"http://dbpedia.org/ontology/deathDate>	<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>	\"test\"^^<urn://test>" , true});
