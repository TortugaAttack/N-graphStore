...
public class TripleTest {
	...
	public static Collection<Object[]> data() {
		...
		testConfigs
				.add(new Object[] { new String[] { "a", "b", "c", "d" }, new String[] { "a", "b", "c", "d" }, true });
		testConfigs
				.add(new Object[] { new String[] { "a", "b", "c", "d" }, new String[] { "a", "b", "c", "e" }, false });
		testConfigs
				.add(new Object[] { new String[] { "a", "b", "c", "d" }, new String[] { "a", "b", "e", "d" }, false });
		testConfigs
				.add(new Object[] { new String[] { "a", "b", "c", "d" }, new String[] { "a", "e", "c", "d" }, false });
		testConfigs
				.add(new Object[] { new String[] { "a", "b", "c", "d" }, new String[] { "e", "b", "c", "d" }, false });
